...
class ActiePatientListPage extends StatefulWidget {
  const ActiePatientListPage({super.key});

  @override
  State<ActiePatientListPage> createState() => _ActiePatientListPageState();
}

class _ActiePatientListPageState extends State<ActiePatientListPage> {
    ...
    return ValueListenableBuilder(
      ...
      builder: (context, Box<Patient> box, _) {
        final activePatients =
            box.values.where((patient) => patient.status == "active").toList();
